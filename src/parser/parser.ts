  ...
  switch (name) {
    ...
    case 'axes':
      page.axes = {
        ...
        grid_minor_color: str('grid_minor_color'),
        grid_style: str('grid_style') as import('./ast.js').GridStyle | undefined,
        grid_minor_style: str('grid_minor_style') as import('./ast.js').GridStyle | undefined,
