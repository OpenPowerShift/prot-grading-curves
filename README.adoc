...
a `.ptc` study. The playground's *Guide* button opens both,
...
annotate {
  ...
  style = leader;
  views = ["Phase", "Negative sequence", "Residual"];
}
...
times {
  ...
  "Negative-sequence clearance" {
    t = 900 ms;
    at_I2 = 600 A;
    views = ["Negative sequence", "Three times I2"];
  }
}
